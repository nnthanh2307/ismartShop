            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST">
                        ...
                        <input type="text" name="title" id="title" value = "<?php echo $slider["slider_name"] ?>">
                        <label for="slug">Slug</label> <?php echo error("slug") ?>
                        <input type="text" name="slug" id="slug" value = "<?php echo $slider["slug"] ?>" >
                        ...
                        <input type="text" name="num_order" id="num-order" value = "<?php echo $slider["slider_order"] ?>">
                        <label>Hình ảnh</label> <?php echo error("linkimage") ?>
                        <input type="text" name="linkimage" id="linkimage" value = "<?php echo $slider["slider_img"] ?>">
                        <div id="uploadFile">
                        ...
                        <select name="status">
                            <option value="<?php echo $slider["slider_status"] ?>"><?php echo $slider["slider_status"]==1?"Hiển thị": "Chờ duyệt" ?></option>
