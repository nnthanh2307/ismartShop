            ...
            <div class="section-detail">
                <table class="shop-table">
                    ...
                    <tbody>
                        ...
                        ?>
                         <tr class="cart-item">
                            <td class="product-name"><?php echo $item["productName"] ?><strong class="product-quantity">x <?php echo $item["qty"] ?></strong></td>
                            <td class="product-total"><?php echo currency_format($item["subTotal"]) ?></td>
                        </tr>
                        <?php
                                }
                            }
